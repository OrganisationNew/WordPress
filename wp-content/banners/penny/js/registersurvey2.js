...
$(document).ready(function () {
	...
	$('#frmsubmit2').prop('disabled', false);
   ...
   var nw = formatPh(document.forms[0].phoneid2.value);
   if(nw != undefined){
		document.forms[0].phoneid2.value =nw;
	}
	});
	...
	$('#frmsubmit2').click(function(){
		...
		if( board == '')
		{
			...
			$('#errorMsg2').html("Please select a board first");
			$('#frmsubmit2').prop('disabled', false);
			return false;
		...
		if( p == '')
		{
			...
			$('#errorMsg2').css("display","block");
			$('#errorMsg2').html("Enter a valid US number");
			$('#frmsubmit2').prop('disabled', false);
			return false;
...
var nums=new Array('document.forms[0].phoneid2');
